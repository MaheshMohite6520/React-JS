...
let JsxRule5Fragment = () => {
  return  (
    ...
    <>
      ...
      <p>We can write the fragments in 3 ways : 
        1] By using empty angular braces.
        2] By using React.Fragment  
        3] By using Fragment only but for this we need to import Fragment from react like import <span>{"{ Fragment }"}</span> from "react"; </p>
    </>
